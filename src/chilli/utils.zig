...
test "regression: styles.s returns empty when disabled, code when enabled" {
    ...
    try std.testing.expectEqualStrings("\x1b[1m", styles.s(styles.BOLD));
    try std.testing.expectEqualStrings("\x1b[0m", styles.s(styles.RESET));

    // Force disabled: expect empty strings.
    styles.setEnabled(false);
    try std.testing.expectEqualStrings("", styles.s(styles.BOLD));
    try std.testing.expectEqualStrings("", styles.s(styles.RESET));
